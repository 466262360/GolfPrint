...
public class Device {
    ...
    public Common.ERROR_CODE setDeviceParameters(DeviceParameters params) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;

        retval = params.validateParameters();
        if (retval == Common.ERROR_CODE.SUCCESS) {
    ...
    public Common.ERROR_CODE openDevice() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        ...
        if (!isDeviceOpen().booleanValue()) {
            if (this.m_DeviceParameters != null) {
                ...
                if (retval == Common.ERROR_CODE.SUCCESS) {
                    ...
                    if ((this.m_Port != null) && (retval == Common.ERROR_CODE.SUCCESS)) {
                ...
                retval = Common.ERROR_CODE.NO_DEVICE_PARAMETERS;
            }
        } else {
            retval = Common.ERROR_CODE.DEVICE_ALREADY_OPEN;
        }

        return retval;
    }

    public Common.ERROR_CODE closeDevice() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE sendData(Vector<Byte> data) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE sendCommand(String command) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE requestDeviceStatus(int type, Boolean waitforanswer, int timeout) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        String command = "";
        ...
        switch (type) {
            ...
            case 7:
                ...
                break;
            default:
                retval = Common.ERROR_CODE.INVALID_DEVICE_STATUS_TYPE;
        }
        ...
        if ((retval == Common.ERROR_CODE.SUCCESS) && (waitforanswer.booleanValue())) {
    ...
    public Common.ERROR_CODE activateASB(Boolean drawer, Boolean onoffline, Boolean error, Boolean paper, Boolean slip, Boolean panelbutton) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
...
//  }
    ...
    public ASBStatus getASB() {
        ...
        if (this.m_Port != null) {
            ...
            Common.ERROR_CODE rv = this.m_ASBStatus.setASBStatus(ASBData);
            if (rv == Common.ERROR_CODE.SUCCESS) {
...
//  }
    ...
    public Common.ERROR_CODE setCropArea(int num, int x1, int y1, int x2, int y2) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            if ((num < 1) || (num > 10)) {
                retval = Common.ERROR_CODE.INVALID_CROP_AREA_INDEX;
            }
        }
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            if ((x1 < 0) || (x1 > 98) || (x2 < 2) || (x2 > 100) ||
                ...
                retval = Common.ERROR_CODE.INVALID_CROP_AREA;
            }
        }
    ...
    public Common.ERROR_CODE deleteCropArea(int num) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
...
//  }
    ...
    public Common.ERROR_CODE selectReceiptPaper() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE selectSlipPaper(Common.PAPERSIDE side) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        String command = "";
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            switch (side) {
                ...
                case FRONT:
                    ...
                    break;
                default:
                    retval = Common.ERROR_CODE.INVALID_PAPER_SIDE;
            }
        }
    ...
    public Common.ERROR_CODE selectAlignment(Common.ALIGNMENT alignment) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        int iAlignment = 0;
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            switch (alignment) {
                ...
                case RIGHT:
                    ...
                    break;
                default:
                    retval = Common.ERROR_CODE.INVALID_JUSTIFICATION;
            }
    ...
    public Common.ERROR_CODE selectPageMode() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE selectPrintDirection(Common.PRINTDIRECTION direction) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            switch (direction) {
                ...
                case TOPTOBOTTOM:
                    ...
                    break;
                default:
                    retval = Common.ERROR_CODE.INVALID_PRINT_DIRECTION;
            }
    ...
    public Common.ERROR_CODE feedSlipToPrintStartPosition() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE ejectCheck() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE cancelWaitForSlip() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE printString(String string, Common.FONT font, Boolean bold, Boolean underlined, Boolean doubleHeight, Boolean doubleWidth) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        int options = 0;
        String command = "";
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            switch (font) {
                ...
                case FONT_B:
                    ...
                    break;
                default:
                    retval = Common.ERROR_CODE.INVALID_FONT;
            }
        }
    ...
    public Common.ERROR_CODE printPage(int mode) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
        String command = "";
        ...
        if (retval == Common.ERROR_CODE.SUCCESS) {
            switch (mode) {
                ...
                case 1:
                    ...
                    break;
                default:
                    retval = Common.ERROR_CODE.INVALID_PRINT_PAGE_MODE;
            }
        }
    ...
    public Common.ERROR_CODE cutPaper() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
...
//  }
    ...
    public Common.ERROR_CODE resetDevice() {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;
    ...
    public Common.ERROR_CODE registerCallback(CallbackInterface callback) {
        Common.ERROR_CODE retval = Common.ERROR_CODE.SUCCESS;

        if (callback == null) {
            retval = Common.ERROR_CODE.INVALID_CALLBACK_OBJECT;
        } else {
    ...
    public Common.ERROR_CODE unregisterCallback() {
        this.m_callback = null;
