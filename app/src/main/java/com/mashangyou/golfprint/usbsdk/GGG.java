...
public class GGG extends FFF {
    ...
    GGG(DeviceParameters parameters) {
        super(parameters);
        ...
        if (!this.m_deviceParameters.PortName.equals("")) {
            ...
            if (this.m_USBDevice != null) {
                ...
                if (!getUsbPermission()) {
                    ...
                    LogUtils.d("fail to get permisstion ");
        ...
        public void run() {
            ...
            try {
                ...
                if (GGG.this.m_connection == null) {
                    ...
                    GGG.this.m_Error = Common.ERROR_CODE.ERROR_OR_NO_ACCESS_PERMISSION;
                } else {
                ...
                GGG.this.m_Error = Common.ERROR_CODE.NO_ACCESS_GRANTED_BY_USER;
            } catch (Exception e) {
                GGG.this.m_Exception = e;
                CCCC.d(TAG,
                        "Exception in connectToDevice: " + e.toString());
                GGG.this.m_Error = Common.ERROR_CODE.FAILED;
            }

            if ((GGG.this.m_Exception == null)
                    && (GGG.this.m_Error == Common.ERROR_CODE.SUCCESS)) {
                ...
                while (!GGG.this.m_CloseFlag.booleanValue()) {
                    try {
                        ...
                        if (receiveCount > 0) {
                            ...
                            if (GGG.this.m_callbackInfo.ReceivedDataType != Common.DATA_TYPE.NOTHING) {
